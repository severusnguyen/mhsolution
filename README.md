...
```
cd existing_repo
git remote add origin https://gitlab.com/vuchiencong1/mhsolution.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vuchiencong1/mhsolution/-/settings/integrations)
